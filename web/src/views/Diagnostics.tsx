...
export function Diagnostics({state}:{state:Row}){
  ...
  return <><h1 className="page-heading">Actor / Q / V 学习诊断</h1><p className="notice">TD EV 衡量 min(Q1,Q2) 对当前 N-step TD 目标的解释程度；终局不使用后继 V。它不是蒙特卡洛回报 EV，不同 N 的指标不可直接比较。离线 NLL 最佳不等于实战最佳。</p>
