...
class LatestBCAdapterTests(unittest.TestCase):
    def source(self):
        ...
        spec['network_version'] = 'soku_bc_tcn256_joint144_weather9_v2'
    ...
    def test_alias_preserves_weights_and_source(self):
        ...
        self.assertEqual(source['network_version'], 'soku_bc_tcn256_joint144_weather9_v2')
        self.assertEqual(adapted['network_version'], 'soku_iql_tcn256_joint144_weather9_v2')
